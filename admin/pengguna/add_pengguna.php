<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Alamat Satker</label>
				<div class="col-sm-6">
					<input type="text" class="form-control" id="alamat_satker" name="alamat_satker" placeholder="Alamat Satker" required>
				</div>
			</div>
...
<?php
    ...
    //mulai proses simpan data
        $sql_simpan = "INSERT INTO tb_pengguna (nama_pengguna,username,satker,alamat_satker,password,level) VALUES (
        '".$_POST['nama_pengguna']."',
        '".$_POST['username']."',
		'".$_POST['satker']."',
		'".$_POST['alamat_satker']."',
