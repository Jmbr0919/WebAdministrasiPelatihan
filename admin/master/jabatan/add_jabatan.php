	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="kode_ma_jabatan" name="kode_ma_jabatan" placeholder="KODE" required>
				</div>
			</div>
...
<?php
    if (isset ($_POST['Simpan'])){
        ...
        $sql_simpan = "INSERT INTO tb_ma_jabatan (kode_ma_jabatan, uraian) VALUES (
            '".$_POST['kode_ma_jabatan']."',
			'".$_POST['uraian']."')";
